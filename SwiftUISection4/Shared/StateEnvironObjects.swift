...
struct StateEnvironObjects: View {
    ...
    var body: some View {
        ...
        .navigationTitle("StateObject&EnvironmentObject")
    }
}

struct StateEnvironObjects_Previews: PreviewProvider {
